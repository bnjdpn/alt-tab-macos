...
/// * performance: the `HW` in the name seems to imply better performance, and it was observed by some contributors that it seems to be faster (see https://github.com/benjamindupin/alt-tab-pro-but-free/issues/45) than other methods
/// * quality: medium
